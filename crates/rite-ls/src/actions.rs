...
pub static ALL: &[ActionMeta] = &[
    ...
    ActionMeta {
        name: "shamir_split",
        short: "Split secret using Shamir's Secret Sharing",
        long: "Split secret using Shamir's Secret Sharing.",
    },
    ActionMeta {
        name: "shamir_combine",
        short: "Reconstruct secret from Shamir shares",
        long: "Reconstruct secret from Shamir shares.",
    },
    ActionMeta {
        name: "attest",
